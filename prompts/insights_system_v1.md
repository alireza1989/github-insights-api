...
Correct narrative:
  "Review load is strongly concentrated: a single reviewer (alice) submitted 41% of all 312 reviews,
   yielding a Gini coefficient of 0.72 [ev-1, ev-2]. This level of concentration suggests the team
   depends heavily on one individual for code quality assurance [ev-3]."
